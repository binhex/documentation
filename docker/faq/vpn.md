...
***Cause***
Out of date ovpn config file containing reference to retired VPN remote server(s).

***Solution***
Download the latest ovpn config file from your VPN provider, place in /config/openvpn/ and restart container.
